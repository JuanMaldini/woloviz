...
const cloudfrontBaseUrl = import.meta.env.VITE_CLOUDFRONT_URL;
const imageBaseUrl = import.meta.env.DEV
  ? "/projects/Sampleai"
  : `${cloudfrontBaseUrl}/Sampleai`;
  ...
  scenes: [
    {
      id: "scene1",
      name: "Scene 1",
      imageUrl: `${imageBaseUrl}/Sample_AI09_01.jpg`,
      equirectWidth: 4000,
    ...
    },
    {
      id: "scene2",
      name: "Scene 2",
      imageUrl: `${imageBaseUrl}/Sample_AI09_02.jpg`,
      equirectWidth: 4000,
      linkHotspots: [
    ...
    },
    {
      id: "scene3",
      name: "Scene 3",
      imageUrl: `${imageBaseUrl}/Sample_AI09_03.jpg`,
      equirectWidth: 4000,
      linkHotspots: [
        { yaw: 78.85, pitch: -39.85, target: "scene1" },
    ...
    },
    {
      id: "scene4",
      name: "Scene 4",
      imageUrl: `${imageBaseUrl}/Sample_AI09_04.jpg`,
      equirectWidth: 4000,
      linkHotspots: [
    ...
    },
    {
      id: "scene5",
      name: "Scene 5",
      imageUrl: `${imageBaseUrl}/Sample_AI09_05.jpg`,
      equirectWidth: 4000,
      linkHotspots: [
    ...
    },
    {
      id: "scene6",
      name: "Scene 6",
      imageUrl: `${imageBaseUrl}/Sample_AI09_06.jpg`,
      equirectWidth: 4000,
      linkHotspots: [
        {
    ...
    },
    {
      id: "scene7",
      name: "Scene 7",
      imageUrl: `${imageBaseUrl}/Sample_AI09_07.jpg`,
      equirectWidth: 4000,
      linkHotspots: [
        {
    ...
    },
    {
      id: "scene8",
      name: "Scene 8",
      imageUrl: `${imageBaseUrl}/Sample_AI09_08.jpg`,
      equirectWidth: 4000,
      linkHotspots: [
        {
    ...
    },
    {
      id: "scene9",
      name: "Scene 9",
      imageUrl: `${imageBaseUrl}/Sample_AI09_09.jpg`,
      equirectWidth: 4000,
      linkHotspots: [
        {
...
const SampleAI = () => {
  ...
  const assetUrls = useMemo(
    () => ({
      floorplan: `${imageBaseUrl}/Floorplan.png`,
